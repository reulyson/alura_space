...
def __str__(self):
    return f"Fotografia [nome=[self.nome]]" # Este método define como o objeto Fotografia será representado como uma string. Isso é útil para facilitar a visualização dos objetos no Django Admin ou em outros lugares.